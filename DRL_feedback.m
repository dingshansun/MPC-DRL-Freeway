...
scenario=3;
% rng('default')
noise_o1=random('Normal',0,150,1,151); % normal distributed noise on the demand
...
for i=1:N/M
    ...
    action=getAction(saved_agent,Observation);
...
TTS_20=10/3600.*((rou_11+rou_12+rou_13+rou_14+rou_21+rou_22).*1000./1000.*2+w_o1_20+w_o2);
